...
export default function OrderProducts() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((r) => {
        console.log("[OrderProducts] products:", r.data);
        setProducts(Array.isArray(r.data) ? r.data : []);
      })
      .catch((e) => {
        console.error("[OrderProducts] load error:", e);
      ...
      <div className="relative z-10 pb-28">
        <header className="flex items-center justify-between px-5 pt-12 pb-6">
          <div className="flex items-center gap-3.5">
            ...
            <h1 className="text-white text-base font-bold leading-[26px]">Order Produk</h1>
          </div>
