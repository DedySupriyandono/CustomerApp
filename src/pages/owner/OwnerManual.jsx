...
// Buku Manual viewer (Owner) — sama pola dgn Manual.jsx & SalesManual.jsx.
// Source: GET /owner/manual → { base64, contentType, fileName }
export default function OwnerManual() {
  ...
  const downloadFile = () => {
    ...
    a.href = url;
    a.download = meta?.fileName || "buku-manual-owner.pdf";
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between px-5 pt-12 pb-4 bg-gradient-to-b from-[#1A0000] to-[#540101]">
        <div className="flex items-center gap-3.5">
          ...
          <h1 className="text-white text-base font-bold leading-[26px]">Manual Book</h1>
        </div>
        {bytes && (
          <button
      ...
      <div className="bg-[#F8F9FC] pb-8" style={{ minHeight: "calc(100vh - 140px)" }}>
        {loading && (
