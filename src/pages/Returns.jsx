...
// Pengembalian Saya — data dari customer_stock_values (Status=Return).
// sold_ref di-set ke nomor return admin saat AdminClose. Header per
// sold_ref + expand detail SN.
//
// Backend: GET /customer/returns/history & /customer/returns/history/:ref
...
export default function Returns() {
  ...
  const toggleExpand = async (returnNumber) => {
    ...
    try {
      const r = await api.get(`/customer/returns/history/${encodeURIComponent(returnNumber)}`);
